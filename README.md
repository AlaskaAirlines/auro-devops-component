...
[![Build Status](https://img.shields.io/github/actions/workflow/status/AlaskaAirlines/auro-devops-component/testPublish.yml?style=for-the-badge)](https://github.com/AlaskaAirlines/auro-devops-component/actions/workflows/testPublish.yml)
[![See it on NPM!](https://img.shields.io/npm/v/@aurodesignsystem/auro-devops-component?style=for-the-badge&color=orange)](https://www.npmjs.com/package/@aurodesignsystem/auro-devops-component)
[![License](https://img.shields.io/npm/l/@aurodesignsystem/auro-devops-component?color=blue&style=for-the-badge)](https://www.apache.org/licenses/LICENSE-2.0)
![ESM supported](https://img.shields.io/badge/ESM-compatible-FFE900?style=for-the-badge)

```shell
$ npm i @aurodesignsystem/auro-devops-component
```
...
Defining the component dependency within each component that is using the `<auro-devops-component>` component.

<!-- AURO-GENERATED-CONTENT:END -->
<!-- AURO-GENERATED-CONTENT:START (REMOTE:url=https://raw.githubusercontent.com/AlaskaAirlines/auro-templates/main/templates/default/partials/usage/componentImport.md) -->

```js
import "@aurodesignsystem/auro-devops-component";
```
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-devops-component@latest/+esm"></script>
```

<!-- AURO-GENERATED-CONTENT:END -->

## auro-devops-component use cases
...
Automated tests are required for every Auro component. See `.\test\auro-devops-component.test.js` for the tests for this component. Run `npm run test` to run the tests and check code coverage. Tests must pass and meet a certain coverage threshold to commit. See [the testing documentation](https://auro.alaskaair.com/support/tests) for more details.
